 ...
 * 
 * @file config.js
 * @description Contains API endpoint and other configuration settings for the customer portal.
 * 
 * API URL Override:
...
const CONFIG = {
     ...
     * PENDING_PHONE: Phone number awaiting verification
     */
    STORAGE_KEYS: {
        TOKEN: 'real_estate_token',
        USER: 'real_estate_user',
        PENDING_PHONE: 'real_estate_pending_phone'
    },
    
    /**
     * Application name for display purposes
     */
    APP_NAME: 'Real Estate - Customer Portal',
...
if (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') {
    console.log('[CONFIG] Customer Portal Configuration:', {
