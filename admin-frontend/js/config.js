 ...
 * 
 * @file config.js
 * @description Contains API endpoint and other configuration settings for the admin portal.
 * 
 * API URL Override:
...
const CONFIG = {
     ...
     */
    STORAGE_KEYS: {
        TOKEN: 'admin_portal_token',
        USER: 'admin_portal_user'
    },
    
    /**
     * Application name for display purposes
     */
    APP_NAME: 'Real Estate - Admin Portal',
...
if (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') {
    console.log('[CONFIG] Admin Portal Configuration:', {
